...
export const codeProps: PropDefinition[] = [
  ...
  },
  {
    name: 'color',
    type: 'string',
    description: 'Code text color - theme color name (e.g., "blue") or any valid color string',
    required: false,
  },
  {
    name: 'block',
    type: 'boolean',
    description: 'Display as code block instead of inline code (adds more padding and renders in BoxView)',
    default: 'false',
    required: false,
  },
  {
  ...
  },
  {
    ...
    description: 'Additional styles to apply (TextStyle for inline, ViewStyle for block)',
    required: false,
  },
  {
    name: 'size',
